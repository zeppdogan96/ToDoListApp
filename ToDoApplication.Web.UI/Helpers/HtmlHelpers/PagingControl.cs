...
namespace ToDoApplication.Web.UI.Helpers.HtmlHelpers
{
    public static class PagingControl
    {
        public static MvcHtmlString Paging(this HtmlHelper helper, int totalItemCount, int pageIndex, int pageSize)
        {
